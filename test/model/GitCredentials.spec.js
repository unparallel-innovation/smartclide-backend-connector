...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GitCredentials', function() {
      beforeEach(function() {
        instance = new SmartClideDbApi.GitCredentials();
      });

      it('should create an instance of GitCredentials', function() {
        // TODO: update the code to test GitCredentials
        expect(instance).to.be.a(SmartClideDbApi.GitCredentials);
      });
