...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CiManager', function() {
      beforeEach(function() {
        instance = new SmartClideDbApi.CiManager();
      });

      it('should create an instance of CiManager', function() {
        // TODO: update the code to test CiManager
        expect(instance).to.be.a(SmartClideDbApi.CiManager);
      });
